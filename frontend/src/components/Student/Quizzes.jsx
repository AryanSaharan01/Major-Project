...
const StudentQuizzes = () => {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <h3 className="text-xl font-semibold text-gray-900 mb-2">{selectedQuiz.title}</h3>
            ...
            {currentQuestion.type === 'coding' && currentQuestion.codingProblem && (
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700 mb-4">{currentQuestion.codingProblem.problemStatement}</p>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Weekly Quizzes</h1>
        <p className="mt-2 text-gray-600">Test your knowledge with interactive quizzes</p>
      </div>
        ...
        <div className="lg:col-span-1">
                ...
                return (
                  <div key={attempt.id} className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex justify-between items-center mt-2">
                      ...
                      <span className="text-xs text-gray-600">{attempt.completedAt}</span>
                    </div>
                  </div>
                );
              })}
          ...
          <div className="bg-blue-50 rounded-xl p-6 mt-6">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <h3 className="font-semibold text-blue-900">Quiz Tips</h3>
            </div>
